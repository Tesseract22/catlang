...
const Self = @This();
pub const CompileError = std.ArrayList(u8).Writer.Error || std.fs.File.WriteError;
compileAll: *const fn (cirs: []Cir, file: std.fs.File.Writer, alloc: std.mem.Allocator, os: std.Target.Os.Tag) CompileError!void,
